...
dataBefore = 'D:/data/yoochoose-data/yoochoose-clicks.dat'
# Path to Original Testing Dataset "Clicks" File
dataTestBefore = 'D:/data/yoochoose-data/yoochoose-test.dat'
# Path to Processed Dataset Folder
dataAfter = 'D:/data/yoochoose-data/yoochose_Process_After/'
...
print(
    ...
    len(trainTR),
    'Events, ',
    trainTR.SessionID.nunique(),
    'Sessions, and',
    trainTR.ItemID.nunique(),
    'Items\n\n')
...
print(
    ...
    len(trainVD),
    'Events, ',
    trainVD.SessionID.nunique(),
    'Sessions, and',
    trainVD.ItemID.nunique(),
    'Items\n\n')
